...
run_interleaved_chunk_test() {
  ...
  cat >"$artifact" <<'EOF'
Mar 17 14:00:00 sf-prod bash[269534]: [compat-invalid-request-debug-json-chunk] {
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_index: 0,
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_count: 1,
Mar 17 14:00:00 sf-prod bash[269534]:   json: '{"request_id":"req_a","provider":"anthropic","anthropic_beta":"caller-a"}'
Mar 17 14:00:00 sf-prod bash[269534]: }
Mar 17 14:00:00 sf-prod bash[269534]: [compat-invalid-request-debug-json-chunk] {
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_index: 0,
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_count: 1,
Mar 17 14:00:00 sf-prod bash[269534]:   json: '{"request_id":"req_b","provider":"anthropic","anthropic_beta":"caller-b"}'
Mar 17 14:00:00 sf-prod bash[269534]: }
Mar 17 14:00:00 sf-prod bash[269534]: [compat-invalid-request-payload-json-chunk] {
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_index: 0,
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_count: 2,
Mar 17 14:00:00 sf-prod bash[269534]:   json: '{"request_id":"req_a","payload":{"messages":[{"role":"user","content":"alpha-'
Mar 17 14:00:00 sf-prod bash[269534]: }
Mar 17 14:00:00 sf-prod bash[269534]: [compat-invalid-request-payload-json-chunk] {
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_index: 0,
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_count: 2,
Mar 17 14:00:00 sf-prod bash[269534]:   json: '{"request_id":"req_b","payload":{"messages":[{"role":"user","content":"beta-'
Mar 17 14:00:00 sf-prod bash[269534]: }
Mar 17 14:00:00 sf-prod bash[269534]: [compat-invalid-request-payload-json-chunk] {
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_index: 1,
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_count: 2,
Mar 17 14:00:00 sf-prod bash[269534]:   json: 'tail"}],"stream":true}}'
Mar 17 14:00:00 sf-prod bash[269534]: }
Mar 17 14:00:00 sf-prod bash[269534]: [compat-invalid-request-payload-json-chunk] {
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_index: 1,
Mar 17 14:00:00 sf-prod bash[269534]:   chunk_count: 2,
Mar 17 14:00:00 sf-prod bash[269534]:   json: 'tail"}],"stream":false}}'
Mar 17 14:00:00 sf-prod bash[269534]: }
EOF

  INNIES_EXTRACT_OUT_DIR="$out_dir" "$SCRIPT" "$artifact" req_a

  assert_json_field "$out_dir/ingress.json" "request_id" "req_a"
  assert_json_field "$out_dir/payload.json" "messages.0.content" "alpha-tail"
  assert_json_field "$out_dir/payload.json" "stream" "true"
}
