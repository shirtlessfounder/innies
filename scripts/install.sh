...
ln -sf "${ROOT_DIR}/scripts/innies-compat-request-bundle-diff.sh" "${BIN_DIR}/innies-compat-request-bundle-diff"
...
echo "  ${BIN_DIR}/innies-compat-request-bundle-diff -> ${ROOT_DIR}/scripts/innies-compat-request-bundle-diff.sh"
