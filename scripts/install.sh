...
ln -sf "${ROOT_DIR}/scripts/innies-compat-first-pass-evidence.sh" "${BIN_DIR}/innies-compat-first-pass-evidence"
...
echo "  ${BIN_DIR}/innies-compat-first-pass-evidence -> ${ROOT_DIR}/scripts/innies-compat-first-pass-evidence.sh"
