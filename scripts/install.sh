...
ln -sf "${ROOT_DIR}/scripts/innies-pause-token.sh" "${BIN_DIR}/innies-pause-token"
ln -sf "${ROOT_DIR}/scripts/innies-set-contribution-cap.sh" "${BIN_DIR}/innies-set-contribution-cap"
...
ln -sf "${ROOT_DIR}/scripts/innies-refresh-token-usage.sh" "${BIN_DIR}/innies-refresh-token-usage"
...
echo "  ${BIN_DIR}/innies-pause-token -> ${ROOT_DIR}/scripts/innies-pause-token.sh"
echo "  ${BIN_DIR}/innies-set-contribution-cap -> ${ROOT_DIR}/scripts/innies-set-contribution-cap.sh"
...
echo "  ${BIN_DIR}/innies-refresh-token-usage -> ${ROOT_DIR}/scripts/innies-refresh-token-usage.sh"
